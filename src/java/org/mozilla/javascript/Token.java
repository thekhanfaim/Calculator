...
public class Token {
   ...
   public static boolean isValidToken(int var0) {
      return var0 >= -1 && var0 <= 166;
   }

   public static String keywordToName(int var0) {
      if (var0 != 4) {
         if (var0 != 50) {
            if (var0 != 73) {
               if (var0 != 82) {
   ...
   public static String typeToName(int var0) {
      switch(var0) {
      case -1:
         return "ERROR";
      case 0:
   ...
   public static enum CommentType {
      ...
      static {
         Token.CommentType var0 = new Token.CommentType("LINE", 0);
         LINE = var0;
         Token.CommentType var1 = new Token.CommentType("BLOCK_COMMENT", 1);
         BLOCK_COMMENT = var1;
         Token.CommentType var2 = new Token.CommentType("JSDOC", 2);
         JSDOC = var2;
         Token.CommentType var3 = new Token.CommentType("HTML", 3);
         HTML = var3;
      }
   }
}
