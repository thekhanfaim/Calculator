...
abstract class Icode {
   ...
   static String bytecodeName(int var0) {
      if (validBytecode(var0)) {
   ...
   static boolean validBytecode(int var0) {
      return validIcode(var0) || validTokenCode(var0);
   }

   static boolean validIcode(int var0) {
      return -64 <= var0 && var0 <= 0;
   }

   static boolean validTokenCode(int var0) {
      return 2 <= var0 && var0 <= 81;
   }
}
